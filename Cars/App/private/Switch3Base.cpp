#include "Switch3Base.h"

#include <e3/ViewFactory.h>
#include "CarsValues.h"

Switch3Base::Switch3Base(e3::Element* pParent)
	: Row(pParent)
{
        this->SetBorderSize(e3::Dim("3", "3", "3", "1", "1", "1"));
        this->SetBorderColor(glm::vec4(0, 0, 0, 255));
        this->SetBackgroundColor(glm::vec4(0, 0, 0, 255));
    mAll = e3::ViewFactory::CreateShape( e3::EOrientation::Horizontal);
    AddElement(mAll);
        mAll->SetBackgroundColor(glm::vec4(183, 255, 28, 255));
        mAll->SetPadding(e3::Dim("12", "12", "12", "4", "4", "4"));
        mAllText = e3::ViewFactory::CreateText();
        mAll->AddElement(mAllText);
        mAllText->SetText("BOTH");
        mAllText->SetFontStyle((e3::EFontStyle)2);
        mAllText->SetFontSize(e3::Dim("42", "42", "42", "14", "14", "14"));
